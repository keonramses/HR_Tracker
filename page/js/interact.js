$(document).ready(function () {
  ...
  // Recalculate Responsive Table view - used everytime the show contacts toggle is used
  // to enure that the mobile table is drawn on smaller viewports

  function redrawContactTable() {
    $("#smainContactTable").DataTable().destroy();
    ...
    $("#smainContactTable").DataTable().responsive.recalc();
  }

  function redrawManagerTable() {
    ...
    $("#managerTable").DataTable().responsive.recalc();
  }
  ...
  // ===== Scroll to Top ====
  $(document).ready(function () {
    // check if the "return to top" button should be shown
  ...
  $(document).on("click", ".delete_contact", function () {
    ...
    $("#role_dialog").dialog("close");
    $("#actionRole_alert").dialog("close");
    $("#deleteContact_confirmation")
      .data("contactID", contactID)
      .dialog("open");
  });

  // Add event listeners for all dialogs with the ".ui-dialog" class
  $(".ui-dialog").each(function () {
    var $dialog = $(this);

    // Add an event listener for the dialog's "open" event
